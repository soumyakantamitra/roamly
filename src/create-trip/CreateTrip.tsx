...
function CreateTrip() {
  ...
  const OnGenerateTrip = async () => {
    ...
    if (
      ...
      !formData.budget ||
      !formData.people ||
      parseInt(formData.duration) < 3 ||
      parseInt(formData.duration) > 20
    ) {
  ...
  return (
    <div className="sm:px-10 md:px-32 lg:px-56 xl:px-72 px-5 mt-10 pt-16">
      ...
      <p className="mt-3 text-gray-500 text-xl">
        ...
        design an itinerary you’ll love.
      </p>
      ...
      <div className="mt-20 flex flex-col gap-10">
        ...
        <div>
          <h2 className="text-xl my-3 font-medium">
            Let us know the number of days you plan to travel
          </h2>
          <Input
            type="number"
            placeholder="e.g. 12"
              ...
              className={`my-4 p-4 border rounded-lg cursor-pointer hover:bg-card
                ${
                  formData.budget === item.title
                    ...
                    : "hover:shadow-lg dark:hover:shadow-accent"
                }`}
      ...
      <div>
        <h2 className="text-xl my-3 font-medium">
          Who’s coming along for your next big trip?
        </h2>
