    ...
    <div className="p-3 shadow-sm shadow-border flex justify-between items-center px-5">
      ...
      <div className="flex items-center gap-5">
        ...
        <div className="">
          <Button
            variant="ghost"
            className="size-10 rounded-full shadow-sm shadow-muted-foreground"
            onClick={themeChange}
          >
            {theme === "light" ? (
              <BsSun className="size-5" />
            ) : (
              <BsMoon className="size-5" />
            )}
          </Button>
        </div>
      </div>
